...
const REPO_NAME = "codebend3r/court-vision";
const REPO_URL = `https://github.com/${REPO_NAME}`;

// lucide-react no longer ships brand icons, so the official GitHub mark
// (octicon mark-github) is inlined here.
function GithubMark() {
  return (
