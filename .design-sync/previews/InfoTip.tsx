...
export const InContext = () => (
  <Label
    text="Z-Score"
    tip="Distance from the average pool player in each category, summed with your weights."
  />
);
...
export const MultipleTips = () => (
  <div style={{ display: "grid", gap: "0.75rem", justifyContent: "start" }}>
    <Label
      text="PIE"
      tip="Share of all positive game events the player accounts for while on the floor."
    />
